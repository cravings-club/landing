        ...
        <div className="w-full border-b border-dashed border-zinc-700 py-5">
            <div className="px-20 w-full flex flex-row justify-between">
                ...
                <div className="flex flex-row items-center gap-6 underline-offset-4">
                    ...
                    <a href='#features' className='text-white font-semibold hover:underline decoration-primary'>Features</a>
                    <a href='#pricing' className='text-white font-semibold hover:underline decoration-primary'>Pricing</a>
